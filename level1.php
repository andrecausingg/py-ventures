...
<head>
    ...
    <title>Level 1 | Py-venture</title>
</head>
<body onbeforeunload="return unloading()">
            ...
            <div class="battle-div">                
                ...
                <div class="battle-field">
                    ...
                    <div class="enemy-position">
                        ...
                        <img src="images/characters/enemies/automated bot.png" alt="" class="enemy movement" id="enemy">
                    </div>
                </div>
            </div>
    ...
    <div class="enemy-attack-modal" id="enemy-attack-modal">
        <div class="enemy-attack">
            ...
            <img src="images/characters/enemies/automatedbot-attack.png" alt="" class="beforeAttack" id="enemy-A-image">
        </div>
    </div>
